...
//                }
            std::cout << " to x " <<m.pixFromGrid(wm.getWaypoint().x) << " to y "<< -m.pixFromGrid(wm.getWaypoint().y) <<std::endl;
            std::cout << " now x " <<robot->getX() << " now y "<< robot->getY() << " dis " << m.calculateDis(robot->getX(),robot->getY(),m.pixFromGrid(wm.getWaypoint().x),-m.pixFromGrid(wm.getWaypoint().y)) <<std::endl;
            n=m.calculateDis(robot->getX(),robot->getY(),m.pixFromGrid(wm.getWaypoint().x),-m.pixFromGrid(wm.getWaypoint().y));
